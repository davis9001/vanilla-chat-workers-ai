...
app.get("/", (c) => {
  return c.render(
    <>
      <div className="flex h-screen bg-gray-200 dark:bg-gray-900 dark:text-gray-200">
        <div
        ...
        >
          <div
            id="chat-history"
            className="flex-1 overflow-y-auto p-6 space-y-4 bg-white dark:bg-black flex flex-col-reverse messages-container"
          ></div>
          <div className="px-6 py-2 bg-white dark:bg-black dark:text-white shadow-up">
            <form className="flex items-center" id="chat-form">
              <textarea
                id="message-input"
                className="flex-grow m-2 p-2 border border-chat-border rounded shadow-sm placeholder-chat-placeholder dark:bg-dark-chat-background"
                placeholder="Type a message..."
              ></textarea>
              <button
                type="submit"
                className="m-2 px-4 py-2 bg-chat-button text-black dark:bg-dark-chat-button dark:text-white rounded hover:bg-gray-300 dark:hover:bg-gray-900"
              >
                Send
              </button>
            </form>
        ...
        <div className="w-80 bg-chat-settings dark:bg-dark-chat-settings dark:text-white p-6 shadow-xl flex flex-col justify-between">
          <div>
            <div className="mb-4">
              <h2 className="text-xl font-semibold">Chat Settings</h2>
              <p className="text-sm text-chat-helpertext dark:text-dark-chat-helpertext mt-1">
            ...
            <form>
              <div className="mb-4">
                ...
                <select
                  id="model-select"
                  className="border border-chat-border rounded w-full py-2 px-3 text-black dark:bg-black dark:text-white leading-tight focus:outline-none focus:shadow-outline"
                ></select>
              </div>
              <div className="mb-4">
                <label className="block text-black dark:text-white text-sm font-bold mb-2">
